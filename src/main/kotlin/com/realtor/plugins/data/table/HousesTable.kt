...
object HousesTable : Table() {
    ...
    val address: Column<String> = varchar("address", length = 1500)
    val mls: Column<String> = varchar("mls", length = 1500)
    val county: Column<String> = varchar("county", length = 1500)
    val city: Column<String> = varchar("city", length = 1500)
    val area: Column<Long> = long("area")
    val neighborhood: Column<String> = varchar("neighborhood", length = 1500)
    val zip: Column<Long> = long("zip")
    val style: Column<String> = varchar("style", length = 1500)
    val builtYear: Column<Long> = long("builtYear")
    val taxes: Column<String> = varchar("taxes", length = 1500)
    val description: Column<String> = varchar("description", length = 1500)
    val dataSource: Column<String> = varchar("dataSource", length = 1500)
    val priceHistoryDate: Column<String> = varchar("priceHistoryDate", length = 1500)
    val priceHistoryDetail: Column<String> = varchar("priceHistoryDetail", length = 1500)
    val restrictions: Column<String> = varchar("restrictions", length = 1500)
    val housingOlderPersonsAct: Column<String> = varchar("housingOlderPersonsAct", length = 1500)
